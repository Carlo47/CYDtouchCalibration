...
public:
  LGFX(void) {
    ...
    {                                       // Set the display panel control.
      ...
      cfg.offset_rotation  = 4;             // offset of display rotation (set 4 to get LANDSCAPE_USP_RIGHT, 
                                            //                                          PORTRAIT_USB_UP, 
                                            //                                          LANDSCAPE_USP_LEFT, 
                                            //                                          PORTRAIT_USB_DOWN for lcd.setRotation(r) r=0..3)
...
/*     {  // Configure touchscreen control settings. (remove if not needed)
      ...
      cfg.offset_rotation = 3; // adjust if display and touch orientation do not match, (set 1 for LANDSCAPE, 3 for PORTRAIT)
      // For SPI connection
